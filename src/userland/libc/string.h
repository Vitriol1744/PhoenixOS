...
#include "errno.h"
    ...
    // Copies one string to another
    // extern errno_t strcpy_s(char* restrict dest, rsize_t destsz, const char*
    // restrict src);
    // Copies a certain amount of characters from one string to another
    extern char*   strncpy(char* restrict dest, const char* restrict src,
                           size_t count);
    // Copies a certain amount of characters from one string to another
    // extern errno_t strncpy_s(char* restrict dest, rsize_t destsz, const char*
    // restrict src, rsize_t count);
    // Concatenates two strings
    extern char*   strcat(char* restrict dest, const char* restrict src);
    // Concatenates two strings
    // extern errno_t strcat_s(char* restrict dest, rsize_t destsz, const char*
    // restrict src);
    // Concatenates a certain amount of characters of two strings
    extern char*   strncat(char* restrict dest, const char* restrict src,
                           size_t count);
    // Concatenates a certain amount of characters of two strings
    // extern errno_t strncat_s(char* restrict dest, rsize_t destsz, const char*
    // restrict src, rsize_t count);
    ...
    // Finds the next token in a byte string
    // extern char* strtok_s(char* restrict str, rsize_t* restrict strmax, const
    // char* restrict delim, char** restrict ptr);
    //
    ...
    // Fills a buffer with a character
    // extern errno_t memset_s(void* dest, rsize_t destsz, int ch, rsize_t
    // count);
    // Copies one buffer to another
    extern void*   memcpy(void* restrict dest, const void* restrict src,
                          size_t count);
    // Copies one buffer to another
    // extern errno_t memcpy_s(void* restrict dest, rsize_t destsz, const void*
    // restrict src, rsize_t count);
    // Moves one buffer to another
    extern void*   memmove(void* dest, const void* src, size_t count);
    // Moves one buffer to another
    extern errno_t memmove_s(void* dest, rsize_t destsz, const void* src,
                             rsize_t count);
    // Copies one buffer to another, stopping after the specified delimiter
    // extern void* memccpy(void* restrict dest, const void* restrict src, int
    // c, size_t count);
    //
    //
    //
