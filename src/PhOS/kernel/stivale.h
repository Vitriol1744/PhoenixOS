...
typedef struct stivale2_stivale2_struct_tag_modulesmodule stivale2_struct_tag_modules_t;
...
typedef struct stivale2_struct_tag_efi_system_table stivale2_struct_tag_efi_system_table_t;
